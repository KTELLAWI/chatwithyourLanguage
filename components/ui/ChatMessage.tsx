...
async function ChatMessage({ chatId, initialMessage, session }: { chatId: string, initialMessage?: Message[], session?: Session }) {
    ...
    //     // }
    //     if (divRef.current) {
    //         if (initialMessage?.length == 0 || initialMessage?.length! <= 3) {
    //             window.scrollTo(0, 0);
    ...
    //console.log("languageeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",language)
    return (
        <div className='p-5 flex-1 '>
            ...
            {/* {messages?.map((message, index) => {
                const isSender = true; //message.user.id === session?.user.id;
                    ...
                    <div key={index} className="flex my-2 ">
                        ...
                        >
                            ...
                            <div className="flex space-x-2">
                                <p>{message.translated?.["tr"] || message.input}</p>
